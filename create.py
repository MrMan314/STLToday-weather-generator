...
for day in response.json()['DailyForecasts']:
	...
	draw.text(((width - margin * 2) / columns * (i + 0.5) + margin, height - 300), f"H: {round(day['Temperature']['Maximum']['Value'])}°C", (255, 255, 255), font = font2, anchor = "mm")
	draw.text(((width - margin * 2) / columns * (i + 0.5) + margin, height - 200), f"L: {round(day['Temperature']['Minimum']['Value'])}°C", (255, 255, 255), font = font2, anchor = "mm")
